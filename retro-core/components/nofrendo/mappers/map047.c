...
**
**
** map047.c: Mapper 47 (MMC3 variant) interface
**
*/
...
static void map_write(uint32 address, uint8 value)
{
    ...
    case 0x8000:
        ...
        mmc_bankrom(8, (value & 0x40) ? 0x8000 : 0xC000, -2 + (prg_offset << 1));
        break;
    ...
    case 0x8001:
        ...
        case 6:
            mmc_bankrom(8, (reg8000 & 0x40) ? 0xC000 : 0x8000, value + (prg_offset << 1));
            break;

        case 7:
            mmc_bankrom(8, 0xA000, value + (prg_offset << 1));
            break;
        }
        break;
